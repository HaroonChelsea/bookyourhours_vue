                ...
                <li>
                  ...
                  <div class="buttons-to-right always-visible">
                    <a
                      ...
                      Manage Candidates <span class="button-info">0</span></a
                    >
                    <a
                      href="#"
                ...
                <li>
                  ...
                  <div class="buttons-to-right always-visible">
                    <a
                      ...
                      class="button ripple-effect"
                      ><i class="icon-material-outline-supervisor-account"></i>
                      Manage Candidates <span class="button-info">3</span></a
                    >
                    <a
                      href="#"
                      class="button gray ripple-effect ico"
                ...
                <li>
                  ...
                  <div class="buttons-to-right always-visible">
                    <a
                      ...
                      class="button ripple-effect"
                      ><i class="icon-material-outline-supervisor-account"></i>
                      Manage Candidates <span class="button-info">7</span></a
                    >
                    <a href="#" class="button dark ripple-effect"
                      ><i class="icon-feather-rotate-ccw"></i> Refresh</a
                    >
                    <a
                      href="#"
                      class="button gray ripple-effect ico"
